 ...
 */
export const calculateMacroTotals = (meals: MealEntry[]): MacroTotals => {
 ...
 */
export const getDefaultMacroTargets = (): NutritionTargets => {
  return {
    kcalTarget: 2200,
    proteinTarget: 120,
    carbTarget: 250,
 ...
 */
export const getMealsForDate = (meals: MealEntry[], date: string): MealEntry[] => {
 ...
 * Get today's meals
 */
export const getTodaysMeals = (meals: MealEntry[]): MealEntry[] => {
