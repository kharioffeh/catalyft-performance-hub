    ...
    switch (event.type) {
      case 'checkout.session.completed': {
        ...
        if (session.mode === 'subscription') {
          ...
          if (!userId) {
            logStep("Missing user_id in session metadata", { userId });
            break;
          }
          ...
          logStep("Billing updated for successful checkout", { userId, plan, subscriptionId: subscription.id });
        }
        break;
      }
      ...
      case 'invoice.payment_succeeded': {
        ...
        if (invoice.subscription) {
          // Update billing status to active and current period end
      ...
      case 'customer.subscription.deleted': {
        ...
        logStep("Subscription deleted and billing updated", { subscriptionId: subscription.id });
        break;
      }
