...
export const AIChatInterface: React.FC = () => {
  ...
  const { messages, isLoading, sendMessage, clearChat } = useAISportsChat();
  ...
  const suggestedQuestions = [
    "How is my readiness trending this week?",
    "Should I train today based on my recovery?",
    "What does my sleep data suggest?",
    "How can I improve my training load?",
    "Am I overtraining based on my metrics?"
  ];
      ...
      <CardHeader className="flex-shrink-0">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2">
            ...
            <div>
              <CardTitle>AI Sports Assistant</CardTitle>
              <CardDescription>
      ...
      <CardContent className="flex-1 flex flex-col space-y-4 p-4">
        {messages.length === 0 ? (
          <div className="flex-1 flex flex-col items-center justify-center space-y-4">
            <div className="text-center text-gray-500 mb-4">
              ...
              <p className="text-lg font-medium">Welcome to your AI Sports Assistant!</p>
        ...
        <form onSubmit={handleSendMessage} className="flex space-x-2">
          <Input
            ...
            placeholder="Ask about your training data, recovery, or performance..."
            disabled={isLoading}
            className="flex-1"
          />
